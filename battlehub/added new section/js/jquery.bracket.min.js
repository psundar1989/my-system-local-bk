...
! function (t) {
	...
	function s(t) {
		var e = t.el;
		return e.find(".team.win").append('<div class="bubble">1st</div><div class="edit"><i class="fa fa-edit" style="color:#2b3641;font-size: 30px;position: absolute; top: -27px;right:-33px;"></i></div>'), e.find(".team.lose").append('<div class="bubble">2nd</div>'), !0
			...
			return Object.defineProperty(n.prototype, "el", {
				...
				this.teamCon.append(function (e, n, r, i) {
					var o = n.height,
						...
						h = !0;
					o < 0 && (h = !1, o = -o), o < 2 && (o = 0);
					var c = t('<div class="edit"><i class="fa fa-edit" style="color:#2b3641;font-size: 30px;position: absolute; top: 37px;"></i></div>').appendTo(r);
